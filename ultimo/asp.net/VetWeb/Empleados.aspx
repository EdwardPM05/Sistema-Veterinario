 ...
 <link href="~/favicon.ico" rel="shortcut icon" type="image/x-icon" />
    ...
    <style>
        ...
        */
        ...
        /* Specific IDs for search buttons. Empleados.aspx uses btnBuscarEmpleado and btnLimpiarBusquedaEmpleado */
        .search-input-group #btnBuscarEmpleado { 
            background-color: var(--btn-custom-bg);
            color: white;
        ...
        .search-input-group #btnBuscarEmpleado:hover {
            background-color: var(--btn-custom-hover-bg);
            border-color: var(--btn-custom-hover-bg);
        }
        .search-input-group #btnLimpiarBusquedaEmpleado {
        ...
        .search-input-group #btnLimpiarBusquedaEmpleado:hover {
