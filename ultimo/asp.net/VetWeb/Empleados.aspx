 ...
 <link href="~/favicon.ico" rel="shortcut icon" type="image/x-icon" />
    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        .search-input-group #btnBuscarEmpleado { background-color: var(--btn-custom-bg); color: white; border-color: var(--btn-custom-bg); border-top-right-radius: 0; border-bottom-right-radius: 0; }
        .search-input-group #btnBuscarEmpleado:hover { background-color: var(--btn-custom-hover-bg); border-color: var(--btn-custom-hover-bg); }
        .search-input-group #btnLimpiarBusquedaEmpleado { background-color: var(--btn-clear-bg); color: white; border-color: var(--btn-clear-bg); border-top-right-radius: 8px; border-bottom-right-radius: 8px; }
        .search-input-group #btnLimpiarBusquedaEmpleado:hover { background-color: var(--btn-clear-hover-bg); border-color: var(--btn-clear-hover-bg); }
    ...
    <form id="form1" runat="server">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse show" id="empleadosSubmenu"> <%-- 'show' class added to keep it open --%>
                        <ul class="nav flex-column">
                            <li class="nav-item"><a class="nav-link active" href="Empleados.aspx"><i class="bi bi-briefcase-fill"></i><span>Ver Empleados</span></a></li> <%-- Marked as active --%>
        ...
        <div class="content">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                <button type="button" class="btn btn-custom me-2" data-bs-toggle="modal" data-bs-target="#empleadoModal" data-mode="add">
                ...
                <div>
                <asp:LinkButton ID="btnImprimirPdfEmpleados" runat="server" CssClass="btn btn-custom" OnClick="btnImprimirPdf_Click">
