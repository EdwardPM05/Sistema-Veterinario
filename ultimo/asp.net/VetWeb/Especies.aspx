  ...
  <link href="~/favicon.ico" rel="shortcut icon" type="image/x-icon" />
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css" />
        ...
        *, *::before, *::after {
        ...
        .search-input-group #btnBuscar { background-color: var(--btn-custom-bg); color: white; border-color: var(--btn-custom-bg); border-top-right-radius: 0; border-bottom-right-radius: 0; }
        .search-input-group #btnBuscar:hover { background-color: var(--btn-custom-hover-bg); border-color: var(--btn-custom-hover-bg); }
        .search-input-group #btnLimpiarBusqueda { background-color: var(--btn-clear-bg); color: white; border-color: var(--btn-clear-bg); border-top-right-radius: 8px; border-bottom-right-radius: 8px; }
        .search-input-group #btnLimpiarBusqueda:hover { background-color: var(--btn-clear-hover-bg); border-color: var(--btn-clear-hover-bg); }
    ...
    <form id="form1" runat="server">
        ...
        <div class="content">
            ...
            <div class="input-group mb-3 search-input-group">
                ...
                <asp:LinkButton ID="btnLimpiarBusqueda" runat="server" OnClick="btnLimpiarBusqueda_Click"
                    CssClass="btn btn-outline-secondary"
                    ToolTip="Limpiar">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <button type="button" class="btn btn-custom" data-bs-toggle="modal" data-bs-target="#especieModal" data-mode="add">
                    ...
                    <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="120px">
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="btnEliminar" runat="server" CommandName="Eliminar"
                                ...
                                CommandArgument="<%# Container.DataItemIndex %>"
                                OnClientClick="return confirm('¿Está seguro de que desea eliminar esta especie?');"
