...
<head runat="server">
    ...
    <style>
        ...
        #especieModal .alert-danger::before {
        ...
        #especieModal .alert-success::before {
        ...
        #especieModal .modal-dialog {
            max-width: 500px; /* Default is 500px, but defining it ensures consistency */
    ...
    <form id="form1" runat="server">
        ...
        <nav class="sidebar">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item"><a class="nav-link active" href="Especies.aspx">Especies</a></li>
            ...
            <asp:GridView ID="gvEspecies" runat="server" AutoGenerateColumns="False" OnRowCommand="gvEspecies_RowCommand"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="180px">
                        <ItemTemplate>
                            <asp:Button ID="btnEditar" runat="server" CommandName="Editar" Text="Editar" CssClass="btn btn-warning btn-sm me-2" CommandArgument="<%# Container.DataItemIndex %>" />
        ...
        <script>
            // JavaScript function to clear the form fields and set "Add" mode
            function clearModalFormAndSetAddMode() {
