...
<head runat="server">
    ...
    <style>
      ...
      .sr-only {
        ...
        /* Specific IDs for search buttons in Razas.aspx */
        .search-input-group #btnBuscarRaza { 
            background-color: var(--btn-custom-bg);
            color: white;
        ...
        .search-input-group #btnBuscarRaza:hover {
            background-color: var(--btn-custom-hover-bg);
            border-color: var(--btn-custom-hover-bg);
        }
        .search-input-group #btnLimpiarBusquedaRaza {
        ...
        .search-input-group #btnLimpiarBusquedaRaza:hover {
