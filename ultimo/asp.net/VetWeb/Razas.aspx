...
<head runat="server">
    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        .search-input-group #btnBuscarRaza { background-color: var(--btn-custom-bg); color: white; border-color: var(--btn-custom-bg); border-top-right-radius: 0; border-bottom-right-radius: 0; }
        .search-input-group #btnBuscarRaza:hover { background-color: var(--btn-custom-hover-bg); border-color: var(--btn-custom-hover-bg); }
        .search-input-group #btnLimpiarRaza { background-color: var(--btn-clear-bg); color: white; border-color: var(--btn-clear-bg); border-top-right-radius: 8px; border-bottom-right-radius: 8px; }
        .search-input-group #btnLimpiarRaza:hover { background-color: var(--btn-clear-hover-bg); border-color: var(--btn-clear-hover-bg); }
    ...
    <form id="form1" runat="server">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse show" id="mascotasSubmenu"> <%-- 'show' class added to keep it open --%>
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item"><a class="nav-link active" href="Razas.aspx"><i class="bi bi-gem"></i><span>Razas</span></a></li> <%-- Marked as active --%>
        ...
        <div class="content">
            ...
            <div class="input-group mb-3 search-input-group">
                ...
                <asp:LinkButton ID="btnBuscarRaza" runat="server" OnClick="btnBuscarRaza_Click"
                ...
                <asp:LinkButton ID="btnLimpiarBusquedaRaza" runat="server" OnClick="btnLimpiarBusquedaRaza_Click"
                    CssClass="btn btn-outline-secondary"
                    ToolTip="Limpiar">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <button type="button" class="btn btn-custom" data-bs-toggle="modal" data-bs-target="#razaModal" data-mode="add">
                    ...
                    <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="120px">
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="btnEliminarRaza" runat="server" CommandName="Eliminar"
                                ...
                                CommandArgument="<%# Container.DataItemIndex %>"
                                OnClientClick="return confirm('¿Está seguro de que desea eliminar esta raza?');"
