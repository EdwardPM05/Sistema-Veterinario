            ...
            <asp:GridView ID="gvRazas" runat="server" AutoGenerateColumns="False" OnRowCommand="gvRazas_RowCommand"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="180px">
                        <ItemTemplate>
                            <asp:Button ID="btnEditarRaza" runat="server" CommandName="Editar" Text="Editar" CssClass="btn btn-primary btn-sm me-2" CommandArgument="<%# Container.DataItemIndex %>" /> <%-- Changed to btn-primary --%>
