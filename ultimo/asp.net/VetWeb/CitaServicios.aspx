                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="180px">
                        <ItemTemplate runat="server"> <%-- Added runat="server" explicitly --%>
                            <asp:Button ID="btnEditarCitaServicio" runat="server" CommandName="Editar" Text="Editar" CssClass="btn btn-primary btn-sm me-2" CommandArgument="<%# Container.DataItemIndex %>" /> <%-- Changed from btn-warning to btn-primary --%>
