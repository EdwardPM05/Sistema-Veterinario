...
<head runat="server">
    ...
    <style>
        ...
        */
        ...
        /* Specific IDs for search buttons in Mascotas.aspx */
        .search-input-group #btnBuscarMascota { 
            background-color: var(--btn-custom-bg);
            color: white;
        ...
        .search-input-group #btnBuscarMascota:hover {
            background-color: var(--btn-custom-hover-bg);
            border-color: var(--btn-custom-hover-bg);
        }
        .search-input-group #btnLimpiarBusquedaMascota {
        ...
        .search-input-group #btnLimpiarBusquedaMascota:hover {
        ...
        .modal-dialog {
            max-width: 600px; /* Default for Mascota modal */
            width: 90%;
        }
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="content">
            ...
            <button type="button" class="btn btn-custom mb-4" data-bs-toggle="modal" data-bs-target="#mascotaModal" data-mode="add">
