...
<head runat="server">
    ...
    <style>
        ...
        #mascotaModal .alert-danger:not(:empty)::before { 
        ...
        /* Ícono solo si el mensaje no está vacío */
        #mascotaModal .alert-success:not(:empty)::before { 
    ...
    <form id="form1" runat="server">
        ...
        <nav class="sidebar">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item"><a class="nav-link active" href="Mascotas.aspx">Mascotas</a></li>
            ...
            <asp:GridView ID="gvMascotas" runat="server" AutoGenerateColumns="False" OnRowCommand="gvMascotas_RowCommand"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="180px">
                        <ItemTemplate>
                            <asp:Button ID="btnEditarMascota" runat="server" CommandName="Editar" Text="Editar" CssClass="btn btn-warning btn-sm me-2" CommandArgument="<%# Container.DataItemIndex %>" />
