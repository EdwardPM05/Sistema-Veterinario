    ...
    <form id="form1" runat="server">
        ...
        <nav class="sidebar" id="sidebarMenu">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link active" data-bs-toggle="collapse" href="#empleadosSubmenu" role="button" aria-expanded="true" aria-controls="empleadosSubmenu">
                        <i class="bi bi-briefcase-fill"></i><span>Empleados</span>
                        <i class="bi bi-chevron-down dropdown-caret"></i>
                    </a>
                    <div class="collapse show" id="empleadosSubmenu"> <%-- 'show' class added to keep it open --%>
                        <ul class="nav flex-column">
                            <li class="nav-item"><a class="nav-link" href="Empleados.aspx"><i class="bi bi-briefcase-fill"></i><span>Ver Empleados</span></a></li>
                            <li class="nav-item"><a class="nav-link active" href="Roles.aspx"><i class="bi bi-person-badge-fill"></i><span>Roles</span></a></li> <%-- Marked as active --%>
                        </ul>
                    </div>
                </li>
            ...
            <asp:GridView ID="gvRoles" runat="server" AutoGenerateColumns="False" OnRowCommand="gvRoles_RowCommand"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="180px">
                        <ItemTemplate>
                            <asp:Button ID="btnEditarRol" runat="server" CommandName="Editar" Text="Editar" CssClass="btn btn-primary btn-sm me-2" CommandArgument="<%# Container.DataItemIndex %>" /> <%-- Changed to btn-primary --%>
