...
<head runat="server">
    ...
    <style>
        ...
        #servicioModal .alert-danger:not(:empty)::before { 
        ...
        /* Ícono solo si el mensaje no está vacío */
        #servicioModal .alert-success:not(:empty)::before { 
    ...
    <form id="form1" runat="server">
        ...
        <nav class="sidebar">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item"><a class="nav-link active" href="Servicios.aspx">Servicios</a></li>
        ...
        <div class="content">
            ...
            <div class="input-group mb-3 search-input-group">
                ...
                <asp:Button ID="btnBuscarServicio" runat="server" CssClass="btn btn-outline-secondary" Text="Buscar" OnClick="btnBuscarServicio_Click" />
                <asp:Button ID="btnLimpiarBusquedaServicio" runat="server" CssClass="btn btn-outline-secondary" Text="Limpiar" OnClick="btnLimpiarBusquedaServicio_Click" />
            </div>

            <!-- Botón para abrir el Modal de Añadir/Editar -->
            <button type="button" class="btn btn-custom mb-4" data-bs-toggle="modal" data-bs-target="#servicioModal" data-mode="add">
            ...
            <asp:GridView ID="gvServicios" runat="server" AutoGenerateColumns="False" OnRowCommand="gvServicios_RowCommand"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Acciones" ItemStyle-Width="180px">
                        <ItemTemplate>
                            <asp:Button ID="btnEditarServicio" runat="server" CommandName="Editar" Text="Editar" CssClass="btn btn-warning btn-sm me-2" CommandArgument="<%# Container.DataItemIndex %>" />
