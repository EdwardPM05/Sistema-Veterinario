...
<head runat="server">
    ...
    <style>
        ...
        */
        ...
        /* Specific IDs for search buttons. Servicios.aspx uses btnBuscarServicio and btnLimpiarBusquedaServicio */
        .search-input-group #btnBuscarServicio { 
            background-color: var(--btn-custom-bg);
            color: white;
        ...
        .search-input-group #btnBuscarServicio:hover {
            background-color: var(--btn-custom-hover-bg);
            border-color: var(--btn-custom-hover-bg);
        }
        .search-input-group #btnLimpiarBusquedaServicio {
        ...
        .search-input-group #btnLimpiarBusquedaServicio:hover {
    ...
    <form id="form1" runat="server">
        ...
        <div class="content">
            ...
            <div class="d-flex justify-content-end align-items-center mb-4">
                <button type="button" class="btn btn-custom me-2" data-bs-toggle="modal" data-bs-target="#servicioModal" data-mode="add">
